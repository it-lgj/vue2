<template>
  <div>
    ...
    <el-row align="middle" :gutter="10" class="ivu-mt mt20">
      ...
      <el-col :span="20">
        <el-table :data="tableData.data" class="tabNumWidth"   max-height="400">
          <el-table-column
            :prop="item.key"
            :label="item.title"
            width="item.minWidth"
...
<script>
  import { infobyconditionApi, topdetailApi,integralListApi } from '@/network/api/user'
  export default {
    name: "UserDetails",
    props:{
      uid: {
